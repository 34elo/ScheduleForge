...
import PerosnalAccountMenu from "../../components/PerosnalAccountMenu/PerosnalAccountMenu.jsx";
import ReportsMenu from "../../components/ReportsMenu/ReportsMenu.jsx";
    ...
    return (
        <Box sx={{display: 'flex', justifyContent: 'center', height: '100vh'}}>
            <Box sx={{width: '100%', maxWidth: '1280px', display: 'flex', flexDirection: 'column', height: '100%'}}>
                ...
                <Box sx={{flex: 1, padding: '20px', paddingBottom: '60px', overflowY: 'auto'}}>
                    <TabContext value={value}>
                ...
                <Box sx={{
                    ...
                    <TabContext value={value}>
                        ...
                        >
                            ...
                            <Tab label="Отчеты" value="2"/>
                            <Tab label="Сотрудники" value="3"/>
                            <Tab label="Личный кабинет" value="4" sx={{backgroundColor: 'black', color: 'white'}}/>
                        </TabList>
                    </TabContext>
                </Box>
            </Box>
